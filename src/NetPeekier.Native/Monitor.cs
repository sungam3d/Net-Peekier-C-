...
public sealed class Monitor : IDisposable
{
    ...
    /// so non-Windows test scenarios and unit tests of Monitor's pure-data
    /// surface can construct a Monitor without touching fwpuclnt.dll.
    ...
    // matching method on Python's Monitor; they keep the firewall state in
